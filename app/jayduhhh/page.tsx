...
const Profile = () => {
  ...
  return (
    <div className="w-full h-full grid grid-cols-[25%_75%] gap-2 p-8 divide-x-2 divide-gray-500/40">
      <div className="w-full">
        ...
        <div className="p-2">
          ...
          <p className="font-satoshi text-white text-center rounded-lg shadow-lg bg-[#363636] p-4">
            Female Rage Artist. Click the Links in my bio to find out more about
            who I am as an artist. #DUHHHGang
          </p>
          ...
          <div className="flex justify-center">
            <button
              ...
              className="bg-[#1da1f2] mb-2 inline-block rounded px-6 py-2.5 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-4 w-4"
            ...
            <button
              ...
              data-te-ripple-init
              data-te-ripple-color="light"
              className="mb-2 inline-block rounded px-6 py-2.5 text-xs font-medium uppercase leading-normal bg-gradient-to-tr from-yellow-500 to-purple-500 via-pink-500 text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-4 w-4"
      ...
      <div className="w-full grid grid-rows-2 gap-4 p-6">
        <div className="w-full grid grid-cols-4 gap-2">
          <div>
            <p className="text-white text-xl text-center">Booking Requests</p>
            <p className="font-satoshi text-xs text-center tapped_txt_blue">
              No Booking Requests
            </p>
          </div>
          <div>
            <p className="text-white text-xl text-center">Upcoming Bookings</p>
            <p className="font-satoshi text-xs text-center tapped_txt_blue">
            ...
            <p className="font-satoshi text-xs text-center tapped_txt_blue">
              <div>
                ...
                <p className="font-satoshi text-xs text-center text-white">
                  @thealley_rva booked @jayduhhh for service "Performance
                  Booking"
                </p>
              </div>
            </p>
        ...
        <div className="rounded-lg shadow-lg bg-[#363636] w-full grid grid-cols-[25%_75%] gap-4">
          <div className="grid grid-rows-3 gap-1">
            <div>
              <p className="font-satoshi text-xl p-2 tapped_txt_blue">Rating</p>
            ...
            <div>
              <p className="font-satoshi text-xl p-2 tapped_txt_blue">
                Professionalism
              </p>
              <div className="flex items-center pl-4">
                <svg
          ...
          <div className="grid grid-cols-2 gap-2 pb-4">
            <div>
              ...
              <Image
                src="/assets/images/jayduhhh-booking-analytics.jpg"
                width={300}
                height={300}
            ...
            <div>
              ...
              <Image
                src="/assets/images/jayduhhh-genre-analytics.jpg"
                width={300}
                height={300}
                className="rounded shadow border-4 border-[#262626]"
                alt="profile"
